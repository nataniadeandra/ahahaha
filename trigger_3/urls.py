...
urlpatterns = [
    ...
    path('hapus_makanan/<str:rname>/<str:rbranch>/<str:foodname>/', views.delete_makanan, name='delete_makanan'),
    ...
    path('hapus_tarif_pengiriman/<str:id>/', views.delete_tarif_pengiriman, name='delete_tarif_pengiriman'),
